...
with tflow.device("/CPU:0"):
    ...
    print(
        "Prediction time for single image: {} seconds".format(
            single_image_prediction_time
        )
    )
    ...
    # print(predictions)
    print(
        "Prediction time for batch of images: {} seconds".format(batch_prediction_time)
    )
...
print("Total CPU script time: {} seconds".format(script_time))
print("We did it, everybody. See you next time!")
print("Kashaf, Bella, Eric, and mean old Tensorflow : CPU Version")
